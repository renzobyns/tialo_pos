        ...
        <header class="bg-white border-b border-slate-200 sticky top-0 z-40">
            <div class="px-8 py-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                    ...
                    <button class="px-5 py-2 rounded-lg border border-slate-200 text-sm font-semibold text-slate-700 hover:bg-slate-100">Download Report</button>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 px-8 py-6 space-y-8">
            ...
            <div class="bg-white border border-slate-200 rounded-xl shadow-sm">
                <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100">
                    ...
                    <a href="modules/reports/index.php" class="text-sm font-semibold text-red-600 hover:text-red-700">View reports →</a>
                </div>
