    ...
    <div class="flex-1 flex flex-col">
        <header class="bg-white border-b border-slate-200 sticky top-0 z-40 page-header">
            <div class="px-6 py-4 flex flex-wrap items-center justify-between gap-4">
                ...
                <a href="export.php?tab=<?php echo urlencode($tab); ?>&period=<?php echo urlencode($period); ?>&payment=<?php echo urlencode($payment_type); ?>&staff=<?php echo (int)$staff_id; ?>&start_date=<?php echo urlencode($start_date); ?>&end_date=<?php echo urlencode($end_date); ?>" class="inline-flex items-center px-4 py-2 rounded-lg bg-red-600 text-white font-semibold hover:bg-red-700 transition">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl p-6 space-y-4">
                    <form class="grid grid-cols-1 md:grid-cols-5 gap-4" method="GET">
                        ...
                        <div>
                            ...
                            <select name="period" class="w-full mt-1 px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-red-500">
