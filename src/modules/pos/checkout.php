                ...
                <form method="POST" action="/index.php?page=pos/process_checkout" class="space-y-4">
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-8">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="customerName" name="customer_name" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                            <div>
                                <label for="customerContact" class="block text-sm font-semibold text-slate-700 mb-2">
                                    Contact Number:
                                </label>
                                <input type="text" id="customerContact" name="customer_contact" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-8">
                        ...
                        <div id="installmentDetails" style="display: none;" class="mt-4 pt-4 border-t-2 border-slate-200 space-y-4">
                            <!-- Customer Details for Installment -->
                            <div>
                                <label for="customerName" class="block text-sm font-semibold text-slate-700 mb-2">
                                    <i class="fas fa-user mr-2 text-amber-600"></i>Customer Name: <span class="text-red-500">*</span>
                                </label>
...
$page_scripts = <<<EOT
    <script>
        ...
        // Initialize state on page load (in case Installment is pre-selected)
        const initialPaymentType = document.querySelector('input[name="payment_type"]:checked').value;
        const isInstallmentInitially = initialPaymentType === 'Installment';
        installmentDetails.style.display = isInstallmentInitially ? 'block' : 'none';
        customerNameInput.required = isInstallmentInitially;
        customerContactInput.required = isInstallmentInitially;
    </script>
EOT;
?>
