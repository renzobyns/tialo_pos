                ...
                <?php while ($product = $products_result->fetch_assoc()): ?>
                    <tr class="border-b border-slate-200 hover:bg-slate-50 transition">
                        ...
                        <td class="px-6 py-4 text-sm space-x-2">
                            ...
                            <a href="/index.php?page=inventory/process_product&action=delete&id=<?php echo $product['product_id']; ?>" class="inline-flex items-center space-x-1 bg-red-100 text-red-700 px-3 py-1 rounded hover:bg-red-200 transition" onclick="return confirm('Delete this product?');">
