...
?>
<?php
$page_title = ($is_edit ? 'Edit' : 'Add') . ' Product - Tialo Japan Surplus';
    ...
    <div class="flex-1 flex flex-col">
        <header class="bg-white border-b border-slate-200 sticky top-0 z-40 page-header">
            <div class="px-6 py-4 flex flex-wrap items-center justify-between gap-4">
                ...
                <a href="/index.php?page=inventory&tab=inventory" class="inline-flex items-center px-4 py-2 rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-100 transition">
        ...
        <main class="flex-1 px-6 py-8">
            <div class="max-w-3xl mx-auto bg-white border border-slate-200 rounded-2xl shadow-sm">
                ...
                <form method="POST" action="/index.php?page=inventory/process_product" class="px-8 py-6 space-y-6" enctype="multipart/form-data">
                    <?php if ($is_edit): ?>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t border-slate-100">
                        <a href="/index.php?page=inventory&tab=inventory" class="px-5 py-2 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 transition">Cancel</a>
