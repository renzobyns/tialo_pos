    ...
    <div class="flex-1 flex flex-col">
        ...
        <header class="bg-white border-b border-slate-200 sticky top-0 z-40 page-header">
            <div class="px-6 py-4 flex flex-wrap items-center justify-between gap-4">
                ...
                <a href="?page=users/user_form" class="inline-flex items-center px-5 py-2.5 rounded-lg bg-red-600 hover:bg-red-700 text-white font-semibold transition">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <form class="flex-1" method="GET">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <?php if ($search !== ''): ?>
                            <a href="?page=users&role=<?php echo urlencode($role_filter); ?>" class="text-sm text-slate-500 hover:text-red-600">Reset</a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    ?>
                        <a href="?page=users&role=<?php echo urlencode($value); ?>&search=<?php echo urlencode($search); ?>" class="px-4 py-2 rounded-full border text-sm font-semibold transition <?php echo $active ? 'bg-red-600 border-red-600 text-white shadow' : 'bg-white border-slate-200 text-slate-600 hover:border-slate-300'; ?>">
                            <?php echo $label; ?>
                        </a>
                    <?php endforeach; ?>
                </div>
